...
public class Notepad extends JFrame implements ActionListener,DocumentListener{
	...
	{	//新建
		...
		{	editArea.requestFocus();
			JOptionPane.showMessageDialog(this,"实力不够，这个功能还在研究！","提示",JOptionPane.WARNING_MESSAGE);
		}//页面设置结束
		//打印
		...
		{	editArea.requestFocus();
			JOptionPane.showMessageDialog(this,"还没想好写点什么","帮助主题",JOptionPane.INFORMATION_MESSAGE);
		}//帮助主题结束
		//关于
